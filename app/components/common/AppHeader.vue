<template>
  ...
  >
    <nav class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      <!-- Logo -->
      <NuxtLink :to="localePath('/')" class="z-10 flex items-center gap-2">
      ...
      <!-- Mobile quick contact + hamburger -->
      <div class="md:hidden flex items-center gap-2 z-10">
        <!-- Telegram -->
        <a
          v-if="telegramLink"
          :href="telegramLink"
          ...
          class="w-8 h-8 flex items-center justify-center text-subtle-light dark:text-subtle-dark hover:text-bronze transition-colors"
          aria-label="Telegram"
        >
      ...
      <button
        class="md:hidden z-10 w-9 h-9 flex items-center justify-center"
